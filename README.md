...
All event data is sourced from StatsBomb via the `statsbombpy` API. The data has been cleaned and pre-processed from [StatsBomb Open Data](https://statsbomb.com/what-we-do/hub/free-data/) to focus only on relevant metrics.
